...
ROOT=/mnt/madehua/fooddata/six_dataset_full.txt

export MASTER_PORT=30000
NCCL_P2P_DISABLE=1 CUDA_VISIBLE_DEVICES=1,3,4,5,6,7 OMP_NUM_THREADS=8 torchrun --nnodes=1 --master_port=$MASTER_PORT --nproc_per_node=6 dinov2/train/train.py \
    --config-file dinov2/configs/train/vitl14.yaml train.dataset_path=RecursiveImageDataset:root=$ROOT train.OFFICIAL_EPOCH_LENGTH=8000 train.batch_size_per_gpu=32 train.output_dir=/mnt/madehua/model/checkpoints/food_vitl14/six_full_dataset
